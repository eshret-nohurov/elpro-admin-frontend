<script setup>
/*
 * Footer Banner Create
 * Создает нижний баннер с переводами, ссылкой и изображением.
 */
...
const submitForm = async () => {
  ...
  try {
    ...
    await globalStore.makeApiRequest({
      method: 'POST',
      url: globalStore.api.endpoints.create_footer_banner_slide,
      data: formData,
      headers: {
